...
{
    public partial class PetshopArama : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            OleDbCommand objCmd = new OleDbCommand("Select * from Sirket where kategori_id=2 and geneladres like '%" + aranan + "%'");
