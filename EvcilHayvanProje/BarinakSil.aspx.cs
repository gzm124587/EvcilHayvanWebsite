...
{
    public partial class BarinakSil : System.Web.UI.Page
    {
        ...
        private void BarinakGetir()
        {
            OleDbCommand objCmd = new OleDbCommand("Select * from Sirket where kategori_id=3");
        ...
        protected void Button_Sil_Click(object sender, EventArgs e)
        {
            ...
            {
                objConn.Open();
                OleDbCommand objCmd = new OleDbCommand("delete from Sirket where sirket_id=@a", objConn);
