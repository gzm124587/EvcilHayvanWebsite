...
{
    public partial class PetshopEkle : System.Web.UI.Page
    {
        ...
        protected void Button_Ekle_Click(object sender, EventArgs e)
        {
            ...
            {
                objConn.Open();
                OleDbCommand objCmd = new OleDbCommand("insert into Sirket(isim,telefon,geneladres,harita,kategori_id) values(@a,@b,@c,@d,2)", objConn);
                ...
                objConn.Close();
                Response.Write("<script language='JavaScript'>alert('Petshop Kaydedildi.');</script>");
                TextBox_Isim.Text = "";
