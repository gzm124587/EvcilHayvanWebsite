...
{
    public partial class VeterinerEkle : System.Web.UI.Page
    {
        ...
        protected void Button_Ekle_Click(object sender, EventArgs e)
        {
            ...
            {
                objConn.Open();
                OleDbCommand objCmd = new OleDbCommand("insert into Sirket(isim,telefon,geneladres,harita,kategori_id) values(@a,@b,@c,@d,1)", objConn);
                ...
                objConn.Close();
                Response.Write("<script language='JavaScript'>alert('Veteriner Kaydedildi.');</script>");
                TextBox_Isim.Text = "";
